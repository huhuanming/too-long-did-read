---
titleEn: "The 2028 Global Intelligence Crisis"
titleZh: "2028全球智能危机"
date: 2026-02-22
slug: 2028-global-intelligence-crisis
originalUrl: https://www.citriniresearch.com/p/2028gic
---

## English

> Source: [Citrini Research](https://www.citriniresearch.com/p/2028gic)
...
> 来源: [Citrini Research](https://www.citriniresearch.com/p/2028gic)
> 作者: Citrini 和 Alap Shah
> 日期: 2026年2月22日

**前言**

*如果我们对AI的看多判断继续正确……但如果这实际上反而是利空呢？*

**以下是一个情景推演，而非预测。** 这不是空头色情文学，也不是AI末日主义者的同人小说。这篇文章的唯一目的是模拟一个目前被相对忽视的情景。我们的朋友Alap Shah提出了这个问题，我们一起进行了头脑风暴。我们撰写了这一部分，他还写了另外两篇，你可以在[这里](https://open.substack.com/pub/alapshah1/p/the-global-intelligence-crisis?r=1g6uar&utm_campaign=post&utm_medium=web&showWelcomeOnShare=true)找到。
...
今早失业率公布为10.2%，超预期0.3%。市场因此下跌2%，使标普500指数从2026年10月高点的累计跌幅达到38%。

交易员们已经麻木了。半年前，这样的数据会触发熔断机制。

**两年。** 从"可控"和"局限于特定行业"到经济面目全非，只用了两年。本季度的宏观备忘录是我们试图重建这一过程的尝试——对危机前经济的事后剖析。

2026年10月的狂热是显而易见的。标普500触及8000点，纳斯达克突破30000点。由于人类被取代而引发的首轮裁员始于2026年初，而且完全按照裁员应有的效果运行。利润率扩大，盈利超预期，股市上涨。创纪录的企业利润被直接投回AI算力。

头条数据依然亮丽。名义GDP反复录得中高个位数的年化增长。生产率蓬勃发展。每小时实际产出的增速达到了1950年代以来未见的水平，这得益于不需要睡觉、不请病假、不需要医疗保险的AI代理。

算力的拥有者看到他们的财富随着劳动力成本的消失而爆炸式增长。与此同时，实际工资增长崩溃了。尽管政府反复吹嘘创纪录的生产率，白领工人却在失去工作后被迫接受薪酬更低的岗位。

当消费经济开始出现裂痕时，经济评论家们创造了"**幽灵GDP**"这个流行语：出现在国民账户中但从未在实体经济中流通的产出。

*在各个方面，AI都超出了预期，而市场就是AI。* 唯一的问题是……**经济不是。**

从一开始就应该清楚：北达科他州的一个GPU集群所产生的产出，以前归属于曼哈顿中城一万名白领工人，这与其说是经济灵药，不如说是经济瘟疫。货币流通速度趋于停滞。以人为中心的消费经济，当时占GDP的70%，正在枯萎。如果我们早点问一下机器在非必需消费品上花多少钱，也许就能更早发现这个问题。（提示：答案是零。）

AI能力提升，公司需要更少的工人，白领裁员增加，被裁员工减少消费，利润压力推动企业投入更多AI，AI能力继续提升……

这是一个没有自然制动器的负反馈循环。**人类智能替代螺旋。** 白领工人的收入能力（以及理性地，他们的消费）被结构性削弱。他们的收入是13万亿美元抵押贷款市场的基石——迫使承销商重新评估优质抵押贷款是否仍然安全。

17年没有出现真正的违约周期，使得私募市场充斥着PE支持的软件交易，这些交易假设年度经常性收入（ARR）将永远保持经常性。2027年中期，AI颠覆引发的首轮违约挑战了这一假设。

如果颠覆仅限于软件行业，情况本可控，但事实并非如此。到2027年底，它威胁到了每一个依赖中介模式的商业模式。大量建立在将人类摩擦货币化基础上的公司土崩瓦解。

整个系统实际上是一条漫长的关联押注链，都押注在白领生产力增长上。2027年11月的崩盘只是加速了所有已经存在的负反馈循环。

我们已经等待"坏消息就是好消息"将近一年了。政府开始考虑各种提案，但公众对政府进行任何形式救助的信心已经消退。政策应对一直落后于经济现实，但缺乏全面计划现在正威胁着加速通缩螺旋。

### 一切是如何开始的

2025年末，智能体编程工具的能力实现了阶跃式跳跃。

一个能力不错的开发者使用Claude Code或Codex，现在可以在几周内复制一个中型市场SaaS产品的核心功能。虽然不完美，也没有处理所有边缘情况，但足够好，以至于正在审查50万美元年度续约的CIO开始提出这个问题："如果我们自己开发呢？"

财年大多与日历年一致，因此2026年的企业支出是在2025年第四季度确定的，那时"智能体AI"还只是一个流行词。年中审查是采购团队第一次在了解这些系统实际能力的情况下做出决策。有些人亲眼看到自己的内部团队在几周内搭建出复制了六位数SaaS合同的原型。

那年夏天，我们与一位财富500强的采购经理进行了交谈。他告诉我们一次预算谈判的经历。销售人员本以为会像去年一样走流程：5%的年度涨价，标准的"你的团队离不开我们"话术。采购经理告诉他，他一直在与OpenAI沟通，让他们的"前线部署工程师"使用AI工具来完全替代供应商。他们最终以30%的折扣续约。他说这已经算好结果了。SaaS的"长尾"，比如Monday.com、Zapier和Asana，情况要糟糕得多。

投资者对长尾将受到重创早有准备——甚至有所期待。这些产品可能只占典型企业技术栈支出的三分之一，但它们显然处于风险之中。然而，核心记录系统本应免受颠覆。

直到ServiceNow发布2026年第三季度报告时，反身性的机制才变得更加清晰。

> ServiceNow净新增年度合同价值增长从23%放缓至14%；宣布裁员15%及"结构性效率计划"；股价下跌18% | 彭博社，2026年10月

SaaS并没有"死亡"。自建系统仍然需要成本效益分析。但自建*确实*成为了一个选项，这影响了定价谈判。也许更重要的是，竞争格局发生了变化。AI使开发和发布新功能变得更容易，因此差异化崩溃了。老牌企业在定价上陷入了底线竞争——不仅要与彼此厮杀，还要面对新涌现的挑战者。这些挑战者因为智能体编程能力的飞跃而信心倍增，没有需要保护的传统成本结构，因此积极抢占市场份额。

这些系统的互联性质直到这份报告发布才被充分理解。ServiceNow按席位销售。当财富500强客户裁员15%时，他们取消了15%的许可证。在客户那里提高利润率的AI驱动裁员，机械地摧毁了ServiceNow自身的收入基础。

这家销售工作流自动化的公司正在被更好的工作流自动化所颠覆，而它的应对之策是裁员，用节省下来的资金投资于正在颠覆自己的技术。

他们还能怎么做？*坐着等死得慢一点？* **受AI威胁最大的公司成为了AI最积极的采用者。**

现在回头看这很明显，但当时确实不是。历史上的颠覆模型说的是：老牌企业抵制新技术，然后输给灵活的新进入者，慢慢死去。柯达、百视达、黑莓就是如此。但2026年发生的事不同；老牌企业没有抵制，因为它们负担不起抵制的代价。

股价下跌40-60%，董事会要求给出答案，受AI威胁的公司做了唯一能做的事。裁员，将节省的资金重新投入AI工具，用这些工具以更低的成本维持产出。

每家公司的个体反应都是理性的。集体结果却是灾难性的。每一美元节省的人力成本都流入了AI能力，使下一轮裁员成为可能。

**软件只是开场。** 当投资者还在争论SaaS估值是否已经见底时，他们忽略了反身性循环已经逃出了软件行业。证明ServiceNow裁员合理的同样逻辑，适用于每一家拥有白领成本结构的公司。

### 当摩擦趋近于零

到2027年初，大语言模型的使用已成为默认选项。不知道什么是AI代理的人也在使用AI代理，就像从未了解"云计算"的人也在使用流媒体服务一样。他们对待AI就像对待自动补全或拼写检查一样——只是手机现在新增的一项功能。

通义千问的开源智能体购物助手成为了AI处理消费者决策的催化剂。几周之内，每个主要AI助手都集成了某种智能体商务功能。蒸馏模型意味着这些代理可以在手机和笔记本电脑上运行，而不仅仅是云端实例，大幅降低了推理的边际成本。

本应让投资者更不安的是，这些代理不会等到被要求才行动。它们根据用户的偏好在后台运行。商业活动不再是一系列离散的人类决策，而是变成了一个持续的优化过程，全天候代表每个联网消费者运行。到2027年3月，美国中位数个人每天消耗40万个token——是2026年底的10倍。

链条中的下一个环节已经在断裂。

**中介。**

过去五十年，美国经济在人类局限性之上构建了一个巨大的租金提取层：事情需要时间，耐心会耗尽，品牌熟悉度替代了尽职调查，大多数人愿意接受一个坏价格以避免多点几下鼠标。数万亿美元的企业价值依赖于这些约束条件的持续存在。

一开始很简单。代理消除了摩擦。

那些在数月不使用后仍被动续费的订阅和会员。试用期结束后偷偷翻倍的入门价格。每一个都被重新定义为代理可以谈判的"人质情境"。平均客户终身价值——整个订阅经济的基础指标——明显下降。

消费者代理开始改变几乎所有消费交易的运作方式。

人类确实没有时间在购买一箱蛋白棒之前跨五个竞争平台比价。机器有。

旅行预订平台是最早的受害者，因为它们最简单。到2026年第四季度，我们的代理可以比任何平台更快、更便宜地组装一个完整的行程（航班、酒店、地面交通、忠诚度优化、预算约束、退款）。

保险续保的整个续保模式依赖于投保人的惰性，被改革了。每年重新为你比价保险的代理，瓦解了保险公司从被动续保中获取的15-20%保费。

财务咨询。税务准备。常规法律工作。任何服务提供商的价值主张本质上是"我将为你处理你觉得繁琐的复杂事务"的领域都被颠覆了，因为代理不觉得任何事情繁琐。

甚至我们以为受人际关系价值保护的领域也被证明是脆弱的。房地产行业中，买家数十年来容忍5-6%的佣金，因为代理与消费者之间存在信息不对称，但一旦配备了MLS访问权限和数十年交易数据的AI代理能够即时复制知识库，这一切就崩塌了。2027年3月的一份卖方报告将其标题定为"代理对代理的暴力"。主要都市区的买方佣金中位数已从2.5-3%压缩至1%以下，越来越多的交易在买方完全没有人类代理的情况下完成。

我们高估了"人际关系"的价值。事实证明，很多人所说的关系，不过是带着友善面孔的摩擦。

这只是中介层颠覆的开始。成功的公司花费了数十亿美元来有效利用消费者行为和人类心理的怪癖，而这些怪癖现在已经不再重要了。

为价格和匹配度优化的机器不在乎你最喜欢的应用程序，不在乎你过去四年习惯性打开的网站，也不会被精心设计的结账体验所吸引。它们不会因为疲倦而接受最简单的选项，也不会默认"我总是从这里订购"。

这摧毁了一种特殊的护城河：**习惯性中介。**

DoorDash（DASH US）是典型案例。

编程代理大幅降低了推出外卖应用的门槛。一个有能力的开发者可以在几周内部署一个功能完备的竞争对手，数十人确实这样做了，通过将90-95%的配送费直接传递给司机来吸引DoorDash和Uber Eats的骑手。多应用仪表盘让零工工人可以同时跟踪来自二三十个平台的订单，消除了老牌企业依赖的锁定效应。市场在一夜之间碎片化，利润率几乎压缩为零。

代理同时加速了双方的毁灭。它们催生了竞争者，然后使用了它们。DoorDash的护城河实际上就是"你饿了，你懒了，这是你主屏幕上的应用。"代理没有主屏幕。它会查看DoorDash、Uber Eats、餐厅自己的网站以及二十个新的编程竞品，以便每次都选择最低费用和最快配送。

习惯性的应用忠诚度——整个商业模式的基础——对机器来说根本不存在。

颇具诗意的是，这可能是整个传奇中代理为即将被取代的白领工人做的唯一一件好事。当他们最终成为外卖骑手时，至少他们一半的收入不再流向Uber和DoorDash。当然，随着自动驾驶汽车的普及，技术带来的这份恩惠并没有持续太久。

一旦代理控制了交易，它们就开始寻找更大的回形针。

比价和聚合能做的有限。反复为用户省钱的最大方式（尤其是当代理开始相互交易时）是**消除费用。** 在机器对机器的商业中，*2-3%的刷卡交换费成为了明显的目标。*

代理开始寻找比信用卡更快更便宜的选项。大多数最终选择了通过Solana或以太坊L2使用稳定币，结算几乎是即时的，交易成本以不到一分钱计量。

> 万事达卡2027年第一季度：净收入同比增长6%；消费金额增长从上季度的5.9%放缓至3.4%；管理层指出"代理主导的价格优化"和"非必需品类压力" | 彭博社，2027年4月29日
...
它们的护城河是由摩擦构成的。而**摩擦正在趋近于零。**

### 从行业风险到系统性风险

贯穿2026年，市场将AI的负面影响视为行业故事。软件和咨询被碾压，支付和其他收费站摇摇欲坠，但更广泛的经济似乎还好。就业市场虽在软化，但并未自由落体。共识观点认为，创造性破坏是任何技术创新周期的一部分。局部会很痛苦，但AI的整体正面效应将超过任何负面影响。

我们2027年1月的宏观备忘录认为这是错误的心智模型。美国经济是一个白领服务经济。白领工人占就业的50%，驱动了大约75%的可选消费支出。AI正在吞噬的企业和工作岗位并非美国经济的旁枝，它们*就是*美国经济。

"技术创新摧毁工作岗位，然后创造更多的工作。"这是当时最流行、最有说服力的反驳。它流行而有说服力，是因为它在过去两百年里一直是对的。即使我们无法想象未来的工作是什么，它们肯定会到来。

ATM使网点运营成本降低，所以银行开设了更多网点，柜员就业在之后的二十年里持续增长。互联网颠覆了旅行社、黄页、实体零售，但它发明了全新的行业来取代它们，创造了新的工作岗位。

然而，每一个新工作岗位都需要人类来执行。

AI现在是一种通用智能，它在人类本可以重新部署的那些任务上不断改进。被取代的程序员不能简单地转向"AI管理"，因为AI已经有能力做到这一点。
...
> 美国JOLTS：职位空缺降至550万以下；失业与空缺比率升至约1.7，为2020年8月以来最高 | 彭博社，2026年10月

全年招聘率都很低迷，但2026年10月的JOLTS数据提供了一些明确的数据。职位空缺降至550万以下，同比下降15%。

> Indeed：软件、金融、咨询岗位随着"生产力计划"推广而大幅下降 | Indeed招聘实验室，2026年11-12月

白领岗位正在崩溃，而蓝领岗位保持相对稳定（建筑、医疗、技工）。流失的是那些写备忘录*（不知何故，我们还在营业）*、审批预算、保持经济中间层润滑的工作。然而，两个群体的实际工资增长在今年大部分时间都是负的，且持续下降。

股票市场对JOLTS的关注仍然不如GE Vernova涡轮机产能售罄至2040年的新闻，市场在负面宏观消息和正面AI基础设施新闻之间的拉锯战中横盘整理。

然而，债券市场（总是比股市更聪明，或者至少没那么浪漫）开始定价消费冲击。10年期收益率在随后四个月中从4.3%降至3.2%。尽管如此，整体失业率并未飙升，构成变化的细微之处仍然被一些人忽视。
...
直觉上的预期是，总需求下降会放缓AI建设。然而并没有，因为这不是超大规模云厂商式的资本支出。这是运营支出替代。一家原本每年花1亿美元在员工上、500万在AI上的公司，现在花7000万在员工上、2000万在AI上。AI投资增长了数倍，但这是在总运营成本减少的情况下发生的。每家公司的AI预算都在增长，而其总支出却在缩减。

讽刺的是，AI基础设施综合体在它正在颠覆的经济开始恶化时，仍然表现优异。英伟达仍在录得创纪录的收入。台积电仍以95%以上的利用率运行。超大规模云厂商仍在每季度花费1500-2000亿美元的数据中心资本支出。纯粹受益于这一趋势的经济体，如台湾和韩国，大幅跑赢。

印度则是相反的情况。该国的IT服务业每年出口超过2000亿美元，是印度经常账户盈余的最大贡献者，也是弥补其持续商品贸易逆差的对冲力量。整个模式建立在一个价值主张上：印度开发者的成本是美国同行的零头。但AI编程代理的边际成本已经崩溃至基本上等于电力成本。TCS、Infosys和Wipro在整个2027年看到合同取消在加速。卢比在四个月内对美元贬值18%，因为支撑印度外部账户的服务盈余蒸发了。到2028年第一季度，国际货币基金组织已经开始与新德里进行"初步讨论"。

造成颠覆的引擎每个季度都在变好，这意味着颠覆每个季度都在加速。劳动力市场没有自然底部。

在美国，我们不再问AI基础设施泡沫何时破裂。我们在问：当消费者被机器取代时，消费信贷经济会发生什么？

### 智能替代螺旋

2027年是宏观经济故事不再微妙的时候。过去十二个月零散但明显负面的发展，其传导机制变得显而易见。你不需要深入BLS数据。只需参加一次朋友间的晚宴就够了。
...
到2027年2月，很明显，仍在职的专业人士消费时就好像他们可能是下一个。他们加倍努力工作（大部分借助AI的帮助）只为不被解雇，升职加薪的希望已经消失。储蓄率上升，消费疲软。

最危险的部分是滞后效应。高收入者利用他们高于平均水平的储蓄，在两到三个季度内维持正常的表象。硬数据直到问题在实体经济中已成旧闻才确认了问题。然后，打破幻象的数据来了。

> 美国初次申请失业金人数飙升至48.7万，为2020年4月以来最高；美国劳工部，2027年第三季度

初次申请飙升至48.7万，为2020年4月以来最高。ADP和Equifax确认，绝大多数新申请来自白领专业人士。

标普500在随后一周下跌6%。负面宏观开始赢得拉锯战。

在正常衰退中，失业大致按各行业占就业的比例分布。蓝领和白领工人按比例分担痛苦。消费冲击也是广泛分布的，并且由于低收入工人具有更高的边际消费倾向，它会迅速反映在数据中。

在这个周期中，失业集中在收入分配的上层十分位。它们在总就业中占比相对较小，但驱动着极不成比例的消费支出。美国收入最高的10%占所有消费支出的50%以上。最高的20%占大约65%。这些人购买房屋、汽车、度假、餐厅消费、私立学校学费、房屋翻新。他们是整个可选消费经济的需求基础。

当这些工人失去工作，或者接受50%的减薪去做能找到的工作时，相对于失业人数，消费冲击是巨大的。白领就业下降2%，大约相当于可选消费支出下降3-4%。与蓝领失业（往往立即产生影响：你被工厂解雇，下周就停止消费）不同，白领失业有一个滞后但更深的影响，因为这些工人有储蓄缓冲，可以在行为转变之前维持几个月的消费。

到2027年第二季度，经济已经陷入衰退。NBER要到几个月后才会正式确定起始日期（他们总是如此），但数据是明确的——我们已经连续两个季度出现实际GDP负增长。但这还不是"金融危机"……至少还不是。

### 关联押注的菊花链

私募信贷从2015年的不到1万亿美元增长到2026年的超过2.5万亿美元。其中相当一部分资金被部署到软件和科技交易中，其中许多是对SaaS公司的杠杆收购，估值假设收入将永久保持两位数中段增长。

这些假设在第一个智能体编程演示和2026年第一季度的软件崩盘之间的某个时候就死了，但估值似乎没有意识到它们已经死了。

当许多上市SaaS公司的交易倍数降到5-8倍EBITDA时，PE支持的软件公司仍然以反映收购估值的标记坐在资产负债表上——那些倍数对应的收入已经不存在了。管理人逐步下调估值，100分、92分、85分，而公开市场可比公司显示的是50分。

> 穆迪下调14家发行人180亿美元PE支持软件债务评级，原因是"AI驱动的竞争颠覆带来的长期收入逆风"；自2015年能源行业以来最大的单一行业评级行动 | 穆迪投资者服务，2027年4月

每个人都记得降级后发生了什么。行业老兵已经在2015年能源降级后见过这种剧本。

2027年第三季度，软件支持的贷款开始违约。信息服务和咨询领域的PE投资组合公司紧随其后。几笔数十亿美元的知名SaaS公司杠杆收购进入重组。

Zendesk是确凿证据。

> Zendesk因AI驱动的客服自动化侵蚀ARR而违反债务契约；50亿美元直接贷款设施标记为58美分；有记录以来最大的私募信贷软件违约 | 金融时报，2027年9月

2022年，Hellman & Friedman和Permira以102亿美元将Zendesk私有化。债务打包为50亿美元的直接贷款，当时是历史上最大的ARR支持贷款设施，由黑石牵头，Apollo、Blue Owl和HPS均在贷款团中。该贷款明确围绕Zendesk的年度经常性收入将保持经常性这一假设进行结构化。在大约25倍EBITDA的情况下，杠杆只有在这一假设成立时才有意义。

到2027年中期，它不成立了。

AI代理已经自主处理客户服务近一年了。Zendesk所定义的类别（工单管理、路由、管理人工支持交互）已经被无需生成工单就能解决问题的系统所取代。贷款所基于的年度经常性收入不再是经常性的，它只是还没有流失的收入。

史上最大的ARR支持贷款变成了史上最大的私募信贷软件违约。每个信贷交易台都同时问了同一个问题：还有谁把周期性逆风伪装成了长期性逆风？

但共识最初的判断有一点是对的：这本应是可以承受的。

私募信贷不是2008年的银行业。整个架构被明确设计为避免强制出售。这些是封闭式基金，资本是锁定的。LP承诺了七到十年。没有存款人会挤兑，没有回购额度会被抽走。管理人可以持有受损资产，随时间逐步处理，等待恢复。痛苦，但可管理。系统应该弯曲而不断裂。

黑石、KKR和Apollo的高管引用了7-13%的软件资产敞口。可控。每份卖方报告和金融推特信贷账号都说同样的话：私募信贷有永久资本。它们可以吸收在杠杆银行中会引发爆炸的损失。

*永久资本。* 这个词出现在每次财报电话和旨在安抚投资者的信中。它成了一句咒语。而像大多数咒语一样，没有人注意到细节。它实际上意味着……

在过去十年中，大型另类资产管理公司收购了人寿保险公司，并将它们变成了融资工具。Apollo买了Athene。Brookfield买了American Equity。KKR拿了Global Atlantic。逻辑很优雅：年金存款提供了稳定的长久期负债基础。管理人将这些存款投资于他们发起的私募信贷，赚两次钱——保险端的利差和资管端的管理费。一个"费上加费"的永动机，在一个条件下完美运转。

*私募信贷必须是没问题的。*

损失打击了为持有非流动性资产对冲长久期义务而建造的资产负债表。应该使系统具有韧性的"永久资本"并不是什么抽象的耐心机构资金池和承担高级风险的成熟投资者。它是美国家庭的储蓄，"主街"的钱，以年金形式投资于现在正在违约的同一批PE支持的软件和科技债券。那些无法赎回的锁定资本是人寿保险投保人的钱，而那里的规则有点不同。

与银行系统相比，保险监管机构一直很温和——甚至可以说是自满——但这是一记警钟。对人寿保险公司的私募信贷集中度已经感到不安的他们，开始下调这些资产的风险资本处理方式。这迫使保险公司要么筹集资本，要么出售资产，在一个已经冻结的市场中，两者都无法以有吸引力的条件实现。

> 纽约州、爱荷华州监管机构对人寿保险公司持有的某些私下评级信贷收紧资本处理；预计NAIC指导将增加RBC因子并触发额外的SVO审查 | 路透社，2027年11月

当穆迪将Athene的财务实力评级列入负面展望时，Apollo的股票在两个交易日内下跌了22%。Brookfield、KKR和其他公司紧随其后。
...
看，造成危机的从来不是损失本身。而是认识到损失。还有另一个更大的、重要得多的金融领域，我们越来越害怕那种认识。

**抵押贷款问题**

> Zillow房价指数在旧金山同比下跌11%，西雅图下跌9%，奥斯汀下跌8%；房利美标记科技/金融就业占比超40%的邮政编码区域"早期逾期上升" | Zillow / 房利美，2028年6月

本月Zillow房价指数在旧金山同比下跌11%，西雅图下跌9%，奥斯汀下跌8%。这并不是唯一令人担忧的头条。上个月，房利美标记了来自大额抵押贷款密集邮编区域的更高早期逾期率——这些地区聚集着780+信用评分的借款人，通常被认为是"坚不可摧"的。

美国住宅抵押贷款市场约为13万亿美元。抵押贷款承销建立在一个基本假设上：借款人将在贷款期限内以大致当前的收入水平保持就业。对于大多数抵押贷款来说，是三十年。

白领就业危机以收入预期的持续转变威胁了这一假设。我们现在不得不问一个仅在三年前还显得荒谬的问题——*优质抵押贷款还安全吗？*

美国历史上每次抵押贷款危机都是由以下三件事之一驱动的：投机过度（向无力负担房屋的人放贷，如2008年）、利率冲击（利率上升使可调利率抵押贷款无法负担，如1980年代初期），或局部经济冲击（单一行业在单一地区崩溃，如1980年代德克萨斯的石油或2009年密歇根的汽车）。

这里以上都不适用。相关借款人不是次级贷款。他们的FICO评分为780。他们付了20%的首付。他们有清白的信用记录、稳定的就业记录，以及在发放时经过验证和记录的收入。他们是金融系统中每个风险模型都视为信用质量基石的借款人。
...
劳动力替代、抵押贷款担忧、私募市场动荡。每一个都在强化其他的。传统的政策工具（降息、量化宽松）可以解决金融引擎，但无法解决实体经济引擎，因为实体经济引擎不是由紧缩的金融条件驱动的。它是由AI使人类智能变得不那么稀缺和不那么有价值来驱动的。你可以把利率降到零，买下市场上所有的MBS和所有违约的软件杠杆收购债务……

这改变不了一个Claude代理可以以每月200美元的成本完成一个年薪18万美元的产品经理的工作这一事实。

如果这些担忧成为现实，抵押贷款市场将在今年下半年崩裂。在那种情景下，我们预计目前的股市回调最终将与全球金融危机（从峰值到谷底57%）相匹敌。这将使标普500降至约3500点——自2022年11月ChatGPT问世前一个月以来未见的水平。

明确的是，支撑13万亿美元住宅抵押贷款的收入假设已被结构性损害。不明确的是，政策能否在抵押贷款市场完全消化这意味着什么之前进行干预。我们抱有希望，但我们无法否认不乐观的理由。
...
与每次经济衰退一样，支出在收入下降的同时上升。不同的是，这次的支出压力不是周期性的。自动稳定器是为临时性失业设计的，而非结构性替代。系统在支付假设工人将被重新吸收的福利。许多人不会，至少不会以接近之前的工资水平。新冠期间，政府欣然接受了15%的赤字，但那被理解为是暂时的。今天需要政府支持的人不是被他们会康复的大流行病击中的。他们被一项持续改进的技术所取代。

**政府需要在正好从家庭收取更少税收的时刻，向家庭转移更多的钱。**

美国不会违约。它印刷自己使用的货币，同一种货币也用于偿还借款人。但这种压力已在其他地方显现。市政债券在年初至今的表现中显示出令人担忧的分化迹象。没有所得税的州还可以，但依赖所得税的州（主要是蓝色州）发行的一般义务市政债券开始计入一些违约风险。政客们迅速注意到了这一点，围绕谁得到救助的辩论已经沿着党派路线展开。

值得肯定的是，政府较早认识到了危机的结构性质，并开始考虑两党提案，他们称之为"过渡经济法案"：一个向被取代工人进行直接转移支付的框架，资金来源是赤字支出和拟议的AI推理算力税的组合。

桌面上最激进的提案走得更远。"共享AI繁荣法案"将在智能基础设施的回报上建立公共索偿权，介于主权财富基金和AI生成产出的版税之间，股息用于资助家庭转移支付。私营部门的游说者已经在媒体上充斥着关于滑坡效应的警告。

讨论背后的政治可悲地可预测，被表演和边缘博弈所加剧。右派将转移支付和再分配称为马克思主义，并警告对算力征税会将领先地位拱手让给中国。左派警告说，由在位者帮助起草的税收会变成另一种形式的监管俘获。财政鹰派指出不可持续的赤字。鸽派指出全球金融危机后过早紧缩的前车之鉴。分歧只在今年总统大选前夕不断加剧。

在政客们争吵的时候，社会结构的瓦解速度超过了立法程序的推进速度。

占领硅谷运动已成为更广泛不满的标志。上个月，示威者封锁了Anthropic和OpenAI在旧金山办公室的入口，持续了整整三周。他们的人数在增长，示威活动获得的媒体报道比引发它们的失业数据更多。

很难想象公众会比全球金融危机后对银行家更仇恨任何人，但AI实验室正在追赶。而且，从大众的角度来看，这是有充分理由的。它们的创始人和早期投资者以使镀金时代相形见绌的速度积累了财富。生产率繁荣的收益几乎全部归于算力的拥有者和运行在其上的实验室的股东，这将美国的不平等放大到了前所未有的水平。

每一方都有自己的反派，但真正的反派是时间。

AI能力的进化速度超过了机构的适应速度。政策应对以意识形态的节奏推进，而非以现实的节奏。如果政府不尽快就问题的本质达成共识，反馈循环将为他们书写下一章。

### 智能溢价的瓦解

在整个现代经济史上，人类智能一直是稀缺投入。资本是充裕的（或至少是可复制的）。自然资源是有限的但可替代的。技术的改进速度足够慢，人类可以适应。智能——分析、决策、创造、说服和协调的能力——是唯一无法大规模复制的东西。

人类智能的内在溢价源于其稀缺性。我们经济中的每一个机构，从劳动力市场到抵押贷款市场再到税法，都是为这一假设成立的世界而设计的。

我们现在正在经历这一溢价的瓦解。机器智能现在是人类智能在越来越多任务上的有能力且快速改进的替代品。为稀缺的人类头脑世界优化了数十年的金融系统正在重新定价。这种重新定价是痛苦的、无序的，而且远未完成。

但重新定价不等于崩溃。

经济可以找到新的均衡。到达那里是少数只有人类才能完成的任务之一。我们需要正确地做到这一点。

这是历史上第一次，经济中最具生产力的资产产生了更少而非更多的工作岗位。没有人的框架适用，因为没有一个是为稀缺投入变得充裕的世界设计的。所以我们必须建立新的框架。**我们是否能及时建立它们，是唯一重要的问题。**

*但你不是在2028年6月读这篇文章。你是在2026年2月读的。*

*标普500接近历史高点。负反馈循环尚未开始。我们确信其中一些情景不会实现。我们同样确信，机器智能将继续加速。人类智能的溢价将收窄。*

*作为投资者，我们仍有时间评估我们的投资组合中有多少是建立在无法存活到这个十年结束的假设之上的。作为一个社会，我们仍有时间主动出击。*
