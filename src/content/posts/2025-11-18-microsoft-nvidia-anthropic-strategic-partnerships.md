---
titleEn: "Microsoft, NVIDIA, and Anthropic Announce Strategic Partnerships"
titleZh: "微软、英伟达和 Anthropic 宣布战略合作伙伴关系"
date: 2025-11-18
slug: microsoft-nvidia-anthropic-strategic-partnerships
originalUrl: https://www.anthropic.com/news/microsoft-nvidia-anthropic-announce-strategic-partnerships
---
...
Microsoft and Anthropic are also expanding their existing partnership to provide broader access to Claude for businesses. Customers of Microsoft Foundry will be able to access Anthropic's frontier Claude models including Claude Sonnet 4.5, Claude Opus 4.1, and Claude Haiku 4.5. This partnership will make Claude the only frontier model available on all three of the world's most prominent cloud services.
...
今天微软、英伟达和 Anthropic 宣布了新的战略合作伙伴关系。Anthropic 正在由英伟达提供支持的 Microsoft Azure 上扩展其快速增长的 Claude AI 模型，这将扩大 Claude 的访问范围，并为 Azure 企业客户提供更多模型选择和新功能。Anthropic 已承诺购买 300 亿美元的 Azure 计算容量，并签约额外高达一吉瓦的计算容量。

英伟达和 Anthropic 首次建立深度技术合作伙伴关系，以支持 Anthropic 的未来增长。Anthropic 和英伟达将在设计和工程方面进行合作，目标是为 Anthropic 模型优化最佳性能、效率和总拥有成本，并为 Anthropic 工作负载优化未来的英伟达架构。Anthropic 的计算承诺最初将是使用英伟达 Grace Blackwell 和 Vera Rubin 系统的高达一吉瓦计算容量。

微软和 Anthropic 还在扩大现有合作，为企业提供更广泛的 Claude 访问。Microsoft Foundry 客户将能够访问 Anthropic 的前沿 Claude 模型，包括 Claude Sonnet 4.5、Claude Opus 4.1 和 Claude Haiku 4.5。这一合作将使 Claude 成为唯一在全球三大最突出云服务上都可用的前沿模型。

微软还承诺继续在微软 Copilot 系列产品中提供 Claude 访问，包括 GitHub Copilot、Microsoft 365 Copilot 和 Copilot Studio。

作为合作的一部分，英伟达和微软分别承诺向 Anthropic 投资高达 100 亿美元和 50 亿美元。

亚马逊仍然是 Anthropic 的主要云提供商和训练合作伙伴。
